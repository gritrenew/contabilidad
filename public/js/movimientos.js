(async function () {
  ...
  try {
    ...
    const [countries, groups, companies, accounts, years] = await Promise.all([
    ...
    if (url.has('companies') || url.has('countries') || url.has('grupos') || url.has('accounts') || url.has('years') || url.has('months') || url.has('search')) {
